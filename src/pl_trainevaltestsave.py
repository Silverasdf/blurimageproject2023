...
# usage: python pl_trainevaltestsave.py <config_file>
import os, sys
...
def main():
    ...
    for i in range(CFG.NUM_OF_MODELS):
        ...
        # Init DataModule
        dm = ImageData(data_dir=CFG.OLD_DIR, batch_size=CFG.BATCH_SIZE)
        dm_2023 = ImageData(data_dir=CFG.NEW_DIR, batch_size=CFG.BATCH_SIZE)
